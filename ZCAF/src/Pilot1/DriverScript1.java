	...
	public static void main(String[] args) throws Exception {
	 ...
	 public static void GUITest32_1(){    
			try {
					 ...
					 JPanel Panel_addRow = addButtonToPanel(btn_ExecuteTC, Color.ORANGE, Color.white, BorderLayout.LINE_END);
					 JPanel Panel_executeTC = addButtonToPanel(btn_AddRow, Color.black, Color.white, BorderLayout.LINE_END);
					 JPanel Panel_deleteRow = addButtonToPanel(btn_DeleteRow, Color.black, Color.white, BorderLayout.LINE_END);
					 
					 //btn.setBounds(250, 150, 150, 30);
					 topPanel.add(Panel_executeTC,BorderLayout.CENTER);
...
//	 				System.out.println("  ... Item " + arr[i][k]);
	 ...
	 static private JPanel addButtonToPanel(JButton myButton,Color background,Color foreground, String orientation) {
